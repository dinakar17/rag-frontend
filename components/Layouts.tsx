...
function Logo({ path, width, height, rotate = false } : { path: string, width: number, height: number, rotate?: boolean }) {
  return (
...
function FancyBackground({ children } : { children: React.ReactNode }) {
  return (
